...
template class Frame_spatial<1>;
template class Frame_spatial<2>;
template class Frame_spatial<3>;

template <int dim> Frame_spatial<dim>::Frame_spatial(const Param *par) {
