...
template class dGFrame_spectral<1>;
template class dGFrame_spectral<2>;
template class dGFrame_spectral<3>;

template <int dim> dGFrame_spectral<dim>::dGFrame_spectral(const Param *par) {
